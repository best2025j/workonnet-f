    ...
    <div class="relative top-72">
      ...
      <div class="py-4 max-w-[864px] text-black-50">
        ...
        <p class="text-xs max-w-[669px]">
          ...
          and forward-thinking recruiters. We offer Job seekers an intuitive
          search experience that matches them with the right opportunities based
          on their skills, experience, and career goals and our platform
          provides recruiters with a streamlined job posting process and
          advanced candidate search tools, enabling you to find the perfect fit
          for your team faster and more efficiently. Whether you're looking to
          build your career or build your team, our platform empowers both job
          seekers and recruiters to connect and succeed.
        </p>
      </div>
    </div>
    <!--  -->
