...
<template>
  ...
  >
    ...
    <div
      class="container mx-auto flex justify-between items-center pl-2 md:pl-0"
    >
      ...
      <div class="flex items-center justify-center space-x-7">
        ...
        >
          <div
            ...
            class="rounded-full border p-0.5 flex items-center justify-center"
          >
            <img
              v-if="!userData?.photo"
    ...
    <div
      ...
      class="md:w-[370px] bg-white shadow py-4 px-4 space-y-4 absolute md:right-[7.5rem] top-14 rounded-[20px]"
    >
