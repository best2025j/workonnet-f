      ...
      >
        <div class="border-b-2 p-4 space-y-2">
          <div class="flex items-start space-x-4">
            ...
            />
            <div class="tracking-wider pl-2">
              <span class="block text-base font-black capitalize">{{
                job.title
              }}</span>
              <span class="text-xs font-semimedium text-gray-500 capitalize">{{
                (job?.recruiter as IRecruiterDetails)?.companyName
              }}</span>
            </div>
          </div>

          <div class="flex space-x-4 items-center relative text-xs">
            <span
              class="border border-black-200 px-3.5 py-2 rounded-8 capitalize"
            >
              {{ job.location }}
            </span>
            <span
          ...
          <div class="space-y-3">
            <div class="flex space-x-4 items-center mt-2">
              ...
              <span class="text-sm text-gray-700">{{
                (job?.recruiter as IRecruiterDetails)?.location
              }}</span>
            </div>
            ...
            <div class="flex space-x-4 items-center mt-2">
              ...
              <span class="text-sm text-gray-700"
                >{{ formatCurrency(job.expectedSalary) }} per month</span
              >
            </div>
            ...
            <div class="flex space-x-4 items-center mt-2">
              ...
              <span class="text-sm text-gray-700">Posted {{formatTimeDiffHuman(job.createdAt)}}</span>
            </div>
          </div>
