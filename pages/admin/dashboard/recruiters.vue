        ...
        <table class="w-full mt-2">
          ...
          <tbody>
            <tr class="h-10">
              ...
              <td class="text-xs pl-10">recruiter@gmail.com</td>
              <td class="text-xs pl-10">2024/05/20</td>
              <td class="text-xs pl-10 flex items-center gap-x-1 pt-2">
                <svg
                  width="18"
                  height="15"
                  viewBox="0 0 18 15"
            ...
            <tr class="h-10 bg-westside-50">
              ...
              <td class="text-xs pl-10">recruiter@gmail.com</td>
              <td class="text-xs pl-10">2024/05/20</td>
              <td class="text-xs pl-10 flex items-center pt-3 gap-x-1">
                <svg
                  width="18"
                  height="15"
                  viewBox="0 0 18 15"
              ...
              <td class="pl-10">
                <button
                  class="bg-westside-600 text-xs text-white px-4 py-2 rounded-20"
                >
                  Active
                </button>
              </td>
