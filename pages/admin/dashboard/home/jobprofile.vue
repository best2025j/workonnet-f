        ...
        <div class="flex justify-between">
          ...
          <div>
            ...
            <div class="flex justify-end space-x-4">
              <button
                class="px-4 py-2 flex space-x-4 items-center rounded-8 border-info-600 border text-info-600 text-xs"
              >
                <svg
                  width="20"
                  height="20"
              ...
              <button
                class="px-4 py-2 rounded-8 flex items-center space-x-4 border-primary-1 border text-primary-1 text-xs"
              >
                <svg
                  width="20"
                  height="20"
              ...
              <button
                class="px-4 py-2 flex items-center space-x-4 rounded-8 border-danger-400 border bg-danger-400 text-xs"
              >
                <svg
                  width="20"
                  height="20"
