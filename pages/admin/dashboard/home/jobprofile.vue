      ...
      <div class="bg-white px-4 py-4 w-1/3 rounded-10">
        ...
        <div class="w-full">
          ...
          <ul class="">
            ...
            >
              <div class="flex items-center space-x-3">
                <img src="/assets/images/Ellipse7.png" alt="microsoft image" />
                <div class="">
                  <h1 class="text-sm">Kristin Watson</h1>
                  <h1 class="text-xs">Applied 2 days ago</h1>
                </div>
              </div>
          ...
          <ul class="">
            ...
            >
              <div class="flex items-center space-x-3">
                <img src="/assets/images/Ellipse9.png" alt="microsoft image" />
                <div class="">
                  <h1 class="text-sm">Leslie Alexander</h1>
                  <h1 class="text-xs">Applied 2 days ago</h1>
                </div>
              </div>
          ...
          <ul class="">
            ...
            >
              <div class="flex items-center space-x-3">
                <img src="/assets/images/Ellipse6.png" alt="microsoft image" />
                <div class="">
                  <h1 class="text-sm">Marvin McKinney</h1>
                  <h1 class="text-xs">Applied 2 days ago</h1>
                </div>
              </div>
