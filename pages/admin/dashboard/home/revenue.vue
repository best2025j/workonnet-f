...
definePageMeta({
  title: "Dashboard",
  pageName: "admin.dashboard.home.revenue",
  layout: "dashboard",
});
</script>
...
<template>
  <div class="h-full w-full">
    <h1 class="capitalize text-2xl font-black font-[Georgia] py-2">revenue</h1>
    ...
    <!--  -->
    <div class="bg-white rounded-10 h-full w-full p-4 my-4">
      <div class="flex justify-between items-center border-b py-4">
        <h1 class="text-lg font-black">Recent Subscriptions</h1>
        <button
          class="text-sm border-primary-1 px-6 rounded-8 py-2.5 border text-primary-1 flex gap-x-2 items-center"
        >
          View all
        </button>
      </div>
      ...
      <!-- table custom -->
      <nav class="mt-4 h-10 flex items-center px-2 bg-westside-100 rounded-t-8">
        <ul class="flex justify-between items-start w-full">
          ...
          <li
            class="text-xs font-black flex gap-x-2 relative right-14 items-center"
          >
            Name
            <svg
              width="18"
          ...
          <li class="text-xs font-black relative right-16">Category</li>
          <li
            class="text-xs font-black flex gap-x-2 relative right-14 items-center"
          >
            Date
          ...
          <li class="text-xs font-black relative right-14">Status</li>
          <li></li>
        </ul>
      </nav>
      <!--  -->
      <table class="w-full mt-2">
        ...
        <tbody>
          <tr class="h-10">
            <td class="text-xs pl-4">010101</td>
            <td class="text-xs pl-8">Anna June</td>
            <td class="text-xs pl-8">Recruiter</td>
            <td class="text-xs pl-8">03/06/2024</td>
            <td class="text-xs pl-8">Premium Plan</td>
            <td class="text-xs pl-8">#45,000</td>
            <td class="pl-8">
              <button
          ...
          <tr class="h-10 bg-westside-100">
            <td class="text-xs pl-4">010101</td>
            <td class="text-xs pl-8">Anna June</td>
            <td class="text-xs pl-8">Job Seeker</td>
            <td class="text-xs pl-8">03/06/2024</td>
            <td class="text-xs pl-8">basic Plan</td>
            <td class="text-xs pl-8">#45,000</td>
            <td class="pl-8">
              <button
          ...
          <tr class="h-10 bg-westside-100">
            ...
            <td class="pl-8">
              <button
                class="bg-danger-500 text-xs text-white px-4 py-2 rounded-20"
              >
                Cancelled
              </button>
            </td>
          ...
          <tr class="h-10 bg-westside-100">
            ...
            <td class="pl-8">
              <button
                class="bg-danger-600 text-xs text-white px-4 py-2 rounded-20"
              >
                Cancelled
              </button>
            </td>
