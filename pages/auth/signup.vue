...
const testimonials = [
  { name: 'John Doe', message: 'Searching and finding your dream job is now easier than ever. Get AI recommended Job Match, Apply and Get Accepted', occupation: 'UI/UX Designer' },
  { name: 'Jane Smith', message: 'I absolutely love it!', occupation: 'UI/UX Designer' },
  { name: 'Alice Johnson', message: 'Highly recommend to everyone!', occupation: 'UI/UX Designer'  },
...
<p class="text-center mt-10 mb-5 text-xl font-['Nexa']">Already have an account? <NuxtLink to="/auth/signin"  class="font-light font-['Nexa'] text-blue-700" >Sign In</NuxtLink> </p>
    ...
    <div class="overflow-hidden">
      ...
      >
        ...
        >
          <p class="text-lg text-white mb-6 font-thin">"{{ testimonial.message }} "</p>
