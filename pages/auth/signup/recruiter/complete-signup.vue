...
const optionalUrlValidator = helpers.withMessage(
  ...
  (value: string) => {
    if (!value) return true; // If the field is empty, it's considered valid
    const urlPattern =
        ...
        <div class="w-full">
          <label class="text-base font-thin mb-2 text-left mt-4"
            ...
            <div class="relative">
              ...
              <span
                class="absolute right-3 top-[62%] transform -translate-y-1/2 pointer-events-none"
              >
                <svg
                  width="16"
                  height="9"
